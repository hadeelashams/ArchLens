...
const styles = StyleSheet.create({
  ...
  browseButton: { backgroundColor: '#1E88E5', paddingHorizontal: 25, paddingVertical: 12, borderRadius: 8 },
  browseText: { color: '#fff', fontWeight: '600', fontSize: 14 },
  previewSection: { marginTop: 0 },
  sectionHeader: { fontSize: 18, fontWeight: '600', color: '#0f172a', marginBottom: 15 },
  ...
  proceedButton: { backgroundColor: '#1E88E5', height: 55, borderRadius: 12, justifyContent: 'center', alignItems: 'center', elevation: 4 },
  disabledButton: { backgroundColor: '#94a3b8', elevation: 0 },
