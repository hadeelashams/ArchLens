          ...
          <View style={styles.mainContent}>
            ...
            <View style={styles.cardContainer}>
              ...
              <DashboardCard
                ...
                subtext={recentProject
                  ? `Current: ${recentProject.name || 'Untitled'}\nEstimate: ₹${(recentProject.totalEstimate || 0).toLocaleString()}`
                  : "Calculate your first construction estimate"}
                iconName="file-document-outline"
                gradientColors={['#2a4179', '#43589a']}
                onPress={() => {
                  if (recentProject) {
                    navigation.navigate('EstimateResult', { projectId: recentProject.id });
                  } else {
