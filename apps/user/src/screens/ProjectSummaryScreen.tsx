                            ...
                            <View key={index} style={styles.detailRow}>
                                <View style={{ flex: 2 }}>
                                    <Text style={styles.detailName}>
                                        {line.materialName || line.name || 'Unknown Material'}
                                    </Text>
                                    {line.type && (
                                    ...
                                    {!line.type && line.desc && (
                                        <Text style={styles.detailDesc}>{line.desc}</Text>
                                    )}
                                </View>
                                <View style={{ flex: 1 }}>
                                    ...
                                    {line.unitPrice && (
                                        <Text style={styles.detailRate}>@ ₹{line.unitPrice.toLocaleString()}</Text>
                                    )}
                                </View>
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                {loading ? (
                    ...
                    <View style={styles.emptyState}>
                        ...
                        <TouchableOpacity style={styles.addBtn} onPress={() => navigation.navigate('ConstructionLevel', { projectId, totalArea: 1000, rooms: route.params?.rooms || [] })}>
                    ...
                    >
                        ...
                        <View style={styles.estimatesContainer}>
                            {estimates.map((item, index) => (
                                <ExpandableEstimateCard key={item.id} item={item} categoryIcons={categoryIcons} />
                            ))}
                        </View>
                ...
                {estimates.length > 0 && (
                    <View style={styles.footer}>
                        ...
                        <View style={styles.footerRight}>
                            <TouchableOpacity style={styles.addMoreBtn} onPress={() => navigation.navigate('ConstructionLevel', { projectId, totalArea: 1000, rooms: route.params?.rooms || [] })}>
...
const styles = StyleSheet.create({
    ...
    // BREAKDOWN SECTION
    breakdownContainer: { paddingHorizontal: 20, paddingVertical: 15, marginBottom: 10 },
    estimatesContainer: { paddingHorizontal: 20 },
    ...
    detailRate: { fontSize: 10, color: '#94a3b8', marginTop: 1 },
